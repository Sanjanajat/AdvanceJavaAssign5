 ...
 * 
 */
package com.nagarro.javatraining.april14.assignment_5.input;

import java.text.ParseException;
import java.util.Date;
import java.util.HashSet;

import com.nagarro.javatraining.april14.assignment_5.controller.Utility;
import com.nagarro.javatraining.april14.assignment_5.model.Constants;
import com.nagarro.javatraining.april14.assignment_5.model.Flight;

/**
 * Class- UserInputValidator
 * 
 * @author sanjanajat Class responsible for validating user query string.
 */
public class UserInputValidator implements Constants {
	...
	/*
	 * public static boolean validateFlightTime(String str) { if(str.length()!=4) {
	 * System.err.println("Flight time not Appropriate"); return false; } int hr ;
	 * int min ; try { hr = Integer.parseInt(str.substring(0, 2)) ; min =
	 * Integer.parseInt(str.substring(2)) ; if((hr<0)||(hr>23)||(min<0)||(min>59)) {
	 * System.err.println("Flight time not Appropriate"); return false; } } catch
	 * (NumberFormatException e) {
	 * System.err.println("Flight time not Appropriate"); return false ; } return
	 * true; }
	 */
